package com.github.principessamia.fileiterator;
...
import static com.github.principessamia.fileiterator.Line.line;

public class FileIterator implements Iterator<Line> {
    ...
    public FileIterator(File input) throws IOException {
